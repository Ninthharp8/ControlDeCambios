...
class formato():
    ...
    def __init__(self):  # Línea eliminada
        pass  # Línea eliminada
...
5, 1.5) + 10 * 20 - 5 * 3
    ...
    print(f"El resultado del cálculo del área del rectángulo con el factor \
aplicado es: {resultado}")  # Línea modificada (ver archivo modificado)
